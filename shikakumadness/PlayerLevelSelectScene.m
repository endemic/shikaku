...
@implementation PlayerLevelSelectScene
...
+(CCScene *) scene
{
    ...
    PlayerLevelSelectScene *layer = [PlayerLevelSelectScene node];
	...
	if ((self = [super init]))
	{
        ...
        if ([levels count] > 0)
        {
            ...
            CCMenuItemImage *deleteButton = [CCMenuItemImage itemFromNormalImage:@"delete-button.png" selectedImage:@"delete-button.png" block:^(id sender) {
                ...
                NSString *pathToFile = [documentsDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"/%@", [GameSingleton sharedGameSingleton].levelToLoad]];
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error
{
    ...
    // TODO: show some sort of error here
}
